...
class FeedbackVO(db.Model):
    ...
    feedbackSubject = db.Column("feedbackSubject", db.String(20))
    feedbackDescription = db.Column("feedbackDescription", db.String(100))
    feedbackRating = db.Column("feedbackRating", db.Integer)
    feedbackDate = db.Column("feedbackDate", db.String(20))
    feedbackTime = db.Column("feedbackTime", db.String(20))
